                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td valign="middle" style="padding-right:10px;">
                        <img src="${env.APP_URL.replace(/\/$/, "")}/press/aloha-logo.png" width="31" height="32" alt="" style="display:block;border:0;outline:none;text-decoration:none;width:31px;height:32px;" />
                      </td>
                      <td valign="middle">
                        <span style="font-family:${DISPLAY_FONT};font-size:28px;line-height:1;letter-spacing:-0.03em;color:${COLORS.ink};font-weight:600;">Aloha</span><span style="font-family:${DISPLAY_FONT};color:${COLORS.primary};font-size:28px;">.</span>
                      </td>
                    </tr>
                  </table>
                </td>

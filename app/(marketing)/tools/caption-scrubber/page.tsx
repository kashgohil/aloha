    ...
    <ToolShell
      ...
      headline={
        <>
          Strip the things
          <br />
          <span className="italic text-primary font-light">that quietly hurt reach.</span>
        </>
      }
      ...
      productFeature={{
        name: "the Composer",
        href: "/composer",
        pitch: "Aloha's Composer scrubs every draft on save and flags risky phrases inline — same logic, no copy-paste round-trip.",
      }}

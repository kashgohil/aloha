...
const ROUTES = [
  ...
  },
  {
    ...
    sla: "Within 4 business hours",
    body:
      "Moving from Buffer, Hootsuite, Later, Sprout, Typefully or Kit. We walk the first import with you, no meetings required.",
    tone: "bg-peach-200",
    link: { href: routes.compare.migrationGuide, label: "Read the guide first" },
  },
  {
    icon: ShieldCheck,
    ...
    sla: "Within 24 hours",
    body:
      "Vulnerability reports, SOC 2 questionnaires, penetration-testing requests. PGP key for sensitive reports is at /.well-known/security.pgp.",
  ...
  },
  {
    ...
    body:
      "Integrations, co-marketing, agency partner programme, affiliate enrolment.",
    tone: "bg-peach-100",
          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-12 items-end">
            <div className="col-span-12 lg:col-span-8">
              ...
              <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[96px]">
                Real people.
                <br />
                <span className="italic text-primary font-light">Real inboxes.</span>
              </h1>
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className="p-6 rounded-3xl bg-background-elev border border-border">
                ...
                <p className="font-display text-[26px] leading-[1.15] tracking-[-0.01em]">
                  Humans online,
                  <br />
                  <span className="italic text-primary">most hours.</span>
                </p>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-14">
            ...
            <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
              Six doors.
              <span className="italic text-primary"> One behind each.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
            {ROUTES.map((r) => (
              ...
              >
                ...
                <p className="mt-3 text-[13.5px] text-ink/75 leading-[1.55]">{r.body}</p>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
              Because
              <br />
              <span className="italic text-primary">forms get lost.</span>
            </h2>
          </div>

          <div className="col-span-12 lg:col-span-7 space-y-6 text-[15.5px] leading-[1.65] text-ink/80">
            <p>
              The universal &ldquo;contact us&rdquo; form is the anti-pattern
              of the customer-support era. Everything gets triaged by
              the same person, who's never the right one, which means
              your question takes three times as long to reach a reply.
            </p>
            <p>
              We broke it into six routes, each landing in a
              domain-expert's inbox. Support gets the product owner on
              call that week. Sales gets the only person who can actually
              negotiate a contract. Security gets the engineer who
              wrote our incident response plan. No forwarding. No
              &ldquo;we've escalated your ticket.&rdquo;
            </p>
            <p>
      ...
      <section className="py-20 lg:py-24">
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-12">
            ...
            <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
              If you need
              <span className="italic text-primary"> postal mail.</span>
            </h2>
          </div>
            ...
            {CITIES.map((c, i) => (
              <article
                ...
                className={`p-7 rounded-3xl ${
                  i === 0 ? "bg-peach-200" : i === 1 ? "bg-primary-soft" : "bg-peach-100"
              ...
              >
                ...
                <p className="mt-5 text-[13px] text-ink/75 leading-[1.55]">{c.address}</p>
              </article>
            ))}
          </div>
          ...
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[32px] lg:text-[44px] leading-[1.05] tracking-[-0.015em]">
                ...
                <br />
                <span className="italic text-primary">one email, no upsell.</span>
              </h2>
              <p className="mt-6 text-[15.5px] text-ink/75 leading-[1.6] max-w-lg">
                One email on Fridays. What we shipped, what we didn't,
                what we're reading. Zero push notifications to
                accompany it.
              </p>
            </div>

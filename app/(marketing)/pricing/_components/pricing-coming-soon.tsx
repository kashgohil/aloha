        ...
        <div className="relative max-w-[1320px] mx-auto px-6 lg:px-10 pt-20 lg:pt-28 pb-32 lg:pb-40">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 max-w-2xl text-[17px] lg:text-[18px] leading-[1.6] text-ink/75">
              Aloha is free right now — connect up to 3 channels, schedule posts,
              and use the AI companion. Paid tiers with more channels and Muse
              (AI that writes in your voice) are coming. Join the wishlist to get
              early access.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              ...
              <article className="rounded-3xl bg-peach-300 p-8 lg:p-10 flex flex-col">
                ...
                <p className="mt-5 text-[14.5px] text-ink/80 leading-[1.55]">
                  ...
                  voice — per channel. We're opening beta access to a small group
                  first. Sign up and we'll be in touch.
                </p>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 mb-14 items-end">
            ...
            <p className="col-span-12 lg:col-span-5 text-[15.5px] text-ink/70 leading-[1.6]">
              Muse will be trained on your own writing. Flip it on for a channel
              and every generation comes out in your cadence — not generic AI.
            </p>
          </div>

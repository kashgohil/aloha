...
const PATHS = [
  {
    ...
    lead:
      "Train and tune the voice model so the Composer drafts in your cadence — not a template.",
    lessons: 6,
  ...
  },
  {
    ...
    lead:
      "Set up a posting rhythm you can keep — weekly, monthly, launch arcs — without burnout.",
    lessons: 5,
  ...
  },
  {
    ...
    lead:
      "Build matrices that handle the choreography while keeping a human approval at every send.",
    lessons: 7,
  ...
  },
  {
    ...
    lead:
      "Cover comments + DMs across eight channels without keeping a tab open.",
    lessons: 4,
  ...
  },
  {
    ...
    lead:
      "Workspaces, white-label reports, and Logic Matrix templates that scale across clients.",
    lessons: 6,
      ...
      <header className="relative overflow-hidden hero-bg pb-16 lg:pb-20">
        ...
        <div className="relative max-w-[1180px] mx-auto px-6 lg:px-10 pt-20 lg:pt-28">
          ...
          <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[96px]">
            Sequenced
            <br />
            <span className="italic text-primary font-light">learning paths.</span>
          </h1>
          <p className="mt-8 max-w-2xl text-[17px] lg:text-[18px] leading-[1.6] text-ink/75">
            Five paths, each with a handful of short lessons that build
            on each other. Designed to go from "what's the voice model"
            to "I trust the voice model with my Wednesday post" in
            roughly an hour.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-10">
            ...
            <h2 className="font-display text-[32px] lg:text-[44px] leading-[1.02] tracking-[-0.02em]">
              Five shapes,
              <br />
              <span className="italic text-primary">in any order you want.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
            {PATHS.slice(1).map((p) => (
              ...
              >
                ...
                <p className="mt-3 text-[14px] text-ink/75 leading-[1.6]">{p.lead}</p>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="font-display text-[32px] lg:text-[44px] leading-[1.02] tracking-[-0.02em]">
              Short lessons,
              <br />
              <span className="italic text-primary">honest pace.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-12 gap-10 items-end">
            <div className="col-span-12 lg:col-span-8">
              <h2 className="font-display text-[36px] sm:text-[48px] lg:text-[64px] leading-[1] tracking-[-0.02em]">
                Pair the path
                <br />
                <span className="italic text-primary">with a free account.</span>
              </h2>
              <p className="mt-5 text-[15.5px] text-ink/70 max-w-lg leading-[1.55]">
                The lessons reference the actual product surfaces. Open
                an account in 30 seconds; the free plan covers
                everything the paths ask of you.
              </p>
            </div>

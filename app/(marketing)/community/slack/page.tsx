...
const CHANNELS = [
  { name: "#field-notes", desc: "Long-form thinking from members. The closest thing to the newsletter in real time.", tone: "bg-peach-100" },
  { name: "#voice-lab", desc: "Show your voice-model experiments. Members who crit kindly.", tone: "bg-primary-soft" },
  { name: "#whats-working", desc: "One-post-a-week wins. No vanity metrics, only useful patterns.", tone: "bg-peach-200" },
  { name: "#product-feedback", desc: "Where the team actually reads.", tone: "bg-peach-300" },
  { name: "#agency-nook", desc: "Just for members on the Agency plan.", tone: "bg-primary-soft" },
  { name: "#off-topic", desc: "Books, chairs, coffee, the weather in Jakarta.", tone: "bg-peach-100" },
];
      ...
      <header className="relative overflow-hidden hero-bg pb-16 lg:pb-20">
        ...
        <div className="relative max-w-[1180px] mx-auto px-6 lg:px-10 pt-20 lg:pt-28">
          ...
          <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[96px]">
            Where Aloha
            <br />
            <span className="italic text-primary font-light">customers talk</span>
            <br />
            to each other.
          </h1>
          <p className="mt-8 max-w-2xl text-[17px] lg:text-[18px] leading-[1.6] text-ink/75">
            Four thousand creators, operators and team members sharing
            what's working, what isn't, and catching the team between
            newsletter issues. Invite-only; quiet by design.
          </p>
          ...
          <p className="mt-4 text-[12.5px] text-ink/55 max-w-xl">
            Invites approved within a business day. Free, no plan
            required. By joining you accept the{" "}
            <a href="#rules" className="pencil-link text-ink">community rules</a>.
          </p>
        </div>
      </header>
          ...
          <div className="grid grid-cols-12 gap-10 mb-14 items-end">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
                Six channels.
                <br />
                <span className="italic text-primary">All active.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 text-[15.5px] text-ink/70 leading-[1.55]">
              We deliberately keep the channel list short. The mothership
              is #whats-working; most people find their way there first.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
            {CHANNELS.map((c) => (
              <article key={c.name} className={`p-7 rounded-3xl ${c.tone} flex flex-col min-h-[180px]`}>
                <div className="flex items-center gap-2 mb-5">
                  <MessageSquare className="w-4 h-4 text-ink/60" />
                  <span className="font-mono text-[13px] font-semibold text-ink">{c.name}</span>
                </div>
                <p className="text-[14px] text-ink/75 leading-[1.6]">{c.desc}</p>
              </article>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-10 mb-12 items-end">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[32px] lg:text-[44px] leading-[1.02] tracking-[-0.02em]">
                Someone's awake,
                <span className="italic text-primary"> somewhere.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 text-[15px] text-ink/70 leading-[1.55]">
              Top six member cities, roughly. The channel cycles around
              the clock — post when you have the thought.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {CITY_PULSE.map((c) => (
              <div key={c.city} className="p-5 rounded-2xl bg-background border border-border">
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-12 gap-10 mb-14 items-end">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
                Four lines.
                <br />
                <span className="italic text-primary">We mean all of them.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 text-[15.5px] text-ink/70 leading-[1.55]">
              Moderation here is three people with name-tags. They're
              gentle, direct, and don't pile on. If something's off,
              message <a href="mailto:moderators@aloha.social" className="pencil-link text-ink">moderators@aloha.social</a>.
            </p>
          </div>
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
            {RULES.map((r, i) => (
              ...
              >
                <span className="font-display italic text-[40px] text-ink/30 leading-none shrink-0">
                  0{i + 1}
                </span>
                <div>
                  ...
                  <p className="mt-3 text-[14px] text-ink/75 leading-[1.6]">{r.p}</p>
                </div>
              </li>
            ))}
          </ol>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
            {[
              ...
              <figure key={i} className={`p-7 rounded-3xl ${t.tone} flex flex-col`}>
                ...
                <figcaption className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-[13.5px] text-ink">{t.n}</p>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
              <div>
                ...
                <p className="font-display text-[32px] lg:text-[42px] leading-[1.1] tracking-[-0.015em] max-w-2xl">
                  Bring your draft,
                  <br />
                  <span className="italic text-peach-300">leave with a tighter one.</span>
                </p>
              </div>

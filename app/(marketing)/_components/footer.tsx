  ...
  return (
    <footer className="bg-background pt-20 lg:pt-24">
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-12 gap-8 pb-16 border-b border-border">
          <div className="col-span-12 lg:col-span-4">
            <Link href={routes.home} className="flex items-baseline gap-1">
              ...
              <span className="font-display text-primary text-[32px] leading-none">.</span>
            </Link>
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              >
                ...
                <div className="leading-tight text-left">
                  <p className="text-[9px] uppercase tracking-[0.18em] text-ink/50">Download</p>
              ...
              >
                ...
                <div className="leading-tight text-left">
                  <p className="text-[9px] uppercase tracking-[0.18em] text-ink/50">Get it on</p>
          ...
          <div className="col-span-12 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8 lg:gap-10 text-[13.5px]">
            {footerLinks.primary.map((col) => (
              <div key={col.heading}>
                <p className="font-display text-[14px] text-ink mb-5">{col.heading}</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 py-14 border-b border-border text-[13.5px]">
          {footerLinks.secondary.map((col) => (
            <div key={col.heading}>
              <p className="font-display text-[14px] text-ink mb-4">{col.heading}</p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 py-10 border-b border-border">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-[13px]">
            ...
            <Link href={routes.resources.status} className="pencil-link inline-flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-primary" />
              All systems normal
            </Link>
            <Link href={routes.trust} className="pencil-link inline-flex items-center gap-2">
        ...
        <div className="py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-[12.5px] text-ink/60">
          <p>
            ...
            <span className="font-display italic text-ink"> care</span> in Lisbon, Oakland &amp; Jakarta.
          </p>

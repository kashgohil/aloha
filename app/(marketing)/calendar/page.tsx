  ...
  return (
    <>
      ...
      <header className="relative overflow-hidden hero-bg">
        ...
        <span aria-hidden className="absolute top-[70%] left-[11%] font-display text-[22px] text-primary/55 rotate-[12deg] select-none">+</span>
        ...
        <div className="relative max-w-[1320px] w-full mx-auto px-6 lg:px-10 pt-20 lg:pt-28 pb-24 lg:pb-32 grid grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="col-span-12 lg:col-span-7">
            ...
            <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[92px]">
              See the week
              <br />
              <span className="italic text-primary font-light">before your</span>
              <br />
              audience does.
            </h1>
            ...
            <p className="mt-8 max-w-[520px] text-[17px] lg:text-[18px] leading-[1.55] text-ink/70">
              ...
              Tuesday before it ships, and trust the queue even when you
              haven't opened it in four days.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <a href="#drag" className="pencil-link inline-flex items-center gap-2 text-[15px] font-medium text-ink">
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <div className="absolute -top-3 -right-2 z-20 rotate-[4deg] pointer-events-none">
              <div className="inline-flex items-center gap-2 bg-ink text-peach-200 px-3 py-1.5 rounded-full shadow-[0_6px_16px_-6px_rgba(23,20,18,0.5)]">
                ...
                <span className="font-display text-[12px]">Apr 13 — 19</span>
              </div>
            </div>
            ...
            <div className="relative animate-[float-soft_9s_ease-in-out_infinite]">
              <div className="rounded-3xl bg-background-elev border border-border-strong shadow-[0_30px_60px_-20px_rgba(23,20,18,0.25)] overflow-hidden">
                <div className="px-5 py-3 flex items-center justify-between border-b border-border bg-muted/40">
                  ...
                  <div className="flex items-center gap-1 text-[10px] font-mono text-ink/50">
                    <button className="px-2 py-0.5 rounded-full text-ink bg-background">Week</button>
                ...
                <div className="grid grid-cols-7 border-b border-border text-[10px] font-mono uppercase tracking-[0.18em] text-ink/55">
                  {DAYS.map((d) => (
                    <div key={d} className="px-2 py-2.5 text-center border-r border-border last:border-r-0">
                      {d}
                    </div>
                  ))}
                </div>
                  ...
                  {DAYS.map((_, i) => (
                    <div key={i} className="relative border-r border-border last:border-r-0">
                      ...
                      <div className="absolute inset-0 grid grid-rows-4 pointer-events-none">
                        {[0, 1, 2, 3].map((k) => (
                          <div key={k} className="border-b border-border/40 last:border-b-0" />
                        ))}
                      </div>
                    </div>
                  ))}
                ...
                <div className="px-5 py-3 border-t border-border bg-muted/40 flex items-center justify-between">
                  <span className="text-[11px] text-ink/55">all channels on voice</span>
                  <div className="flex items-center gap-3">
                    <button className="text-[11px] text-ink/70 pencil-link">Fill gaps</button>
              ...
              <div className="hidden sm:flex absolute -bottom-5 -left-6 lg:-left-10 items-center gap-2.5 bg-background-elev text-ink border border-border-strong rounded-full pl-3 pr-4 py-2 shadow-[0_14px_30px_-16px_rgba(23,20,18,0.35)] -rotate-[3deg]">
                ...
                <span className="text-[11.5px] font-medium">Thu 7pm → Fri 9am</span>
                <span className="text-[11px] text-ink/50 font-mono">· reschedule</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="drag" className="py-24 lg:py-32">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Rearrange the week
              <br />
              <span className="italic text-primary">without opening the draft.</span>
            </h2>
            <p className="mt-6 text-[16px] lg:text-[17px] text-ink/75 leading-[1.6] max-w-lg">
              ...
              in the same beat; if there's a downstream rule — a reply
              window, a template end — the system tells you instead of
          ...
          <div className="grid grid-cols-12 gap-10 mb-14">
            <div className="col-span-12 lg:col-span-6">
              ...
              <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
                The week tells you
                <br />
                <span className="italic text-primary">what's missing.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 lg:col-start-8 text-[16px] text-ink/70 leading-[1.6] self-end">
              Faded ghost slots show where your cadence expects a post.
              Conflict chips flag two LinkedIns in an hour, back-to-back
              carousels, or a day that skipped the channel you promised.
            </p>
          </div>
            ...
            <div className="col-span-12 lg:col-span-5 rounded-3xl bg-ink text-background-elev p-8 lg:p-10 flex flex-col gap-6">
              ...
              <ul className="space-y-5 text-[14px] leading-[1.55]">
                {[
                  ...
                  <li key={c.h}>
                    <p className="font-display text-[17px] tracking-[-0.005em]">{c.h}</p>
                    <p className="mt-1 text-[13px] text-background-elev/65">{c.p}</p>
                  </li>
                ))}
              </ul>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="col-span-12 lg:col-span-6 order-1 lg:order-2">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              A rhythm you can
              <br />
              <span className="italic text-primary">actually keep.</span>
            </h2>
            <p className="mt-6 text-[16px] lg:text-[17px] text-ink/75 leading-[1.6] max-w-lg">
              Tell the Calendar your cadence — three a week for LinkedIn,
              daily for X, one a week for YouTube — and it turns the next
              four weeks into a queue you can fill with drafts, templates,
              or the Composer. Miss a week, the cadence pauses, not panics.
            </p>
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
          <figure className="relative bg-peach-200 rounded-3xl p-10 lg:p-14 overflow-hidden">
            ...
            <blockquote className="font-display text-[26px] lg:text-[34px] leading-[1.2] tracking-[-0.015em] max-w-3xl">
              ...
              week.' Now it's 'what did we learn last week.' The calendar
              did that."
            </blockquote>
            <figcaption className="mt-8 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-ink/60">Head of content · Fermi</p>
              </div>
            </figcaption>
          </figure>
        </div>
          ...
          <div className="grid grid-cols-12 gap-10 items-end">
            <div className="col-span-12 lg:col-span-8">
              <h2 className="font-display text-[44px] sm:text-[56px] lg:text-[80px] leading-[0.98] tracking-[-0.025em]">
                Plan the month.
                <br />
                <span className="italic text-primary">Ship the week.</span>
                <br />
                Mean it.
              </h2>
            </div>

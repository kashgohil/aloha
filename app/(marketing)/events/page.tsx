...
const UPCOMING: EventItem[] = [
  {
    ...
    lead:
      "Aarohi + the Composer team answer unfiltered questions about the voice model — training data, privacy boundaries, how we built the 'teach me' loop. Submit questions in advance.",
    kind: "AMA",
    format: "Virtual",
  ...
  },
  {
    ...
    lead:
      "Four Aloha members read five-minute pieces from their best posts of the quarter. Wine, sparkling water, short Q&A after. Room holds 40; first-come on the list.",
    kind: "Reading",
    format: "Lisbon",
    host: "Leilani O.",
    rsvp: true,
  ...
  },
  {
    ...
    lead:
      "A hands-on workshop with Leah S. (North Handle) and our platform team. Audit your agency setup; 2 hours; tight format, 30 seats.",
    kind: "Workshop",
    format: "Virtual",
...
const PAST: EventItem[] = [
  {
    ...
    lead:
      "45-minute AMA marking the Matrix moving to GA. Covers the 6 starter templates, the human-approve default, and what comes next.",
    kind: "AMA",
    format: "Virtual",
    host: "Aarohi M.",
    recordingUrl: "#",
  ...
  },
  {
    ...
    lead:
      "Quarterly in-person meet-up for Bay Area members. 80 people, informal format, three creator lightning talks.",
    kind: "Meet-up",
    format: "Oakland",
    host: "Kashyap G.",
    recordingUrl: "#",
  ...
  },
  {
    ...
    lead:
      "First-ever field-note reading. Four members, five minutes each, a room of 30. Recording and transcripts linked.",
    kind: "Reading",
    format: "Lisbon",
    host: "Leilani O.",
    recordingUrl: "#",
  ...
  },
  {
    ...
    lead:
      "Three-hour hands-on session: how to train a voice model from your best posts. 25 members attended; recording + slides available.",
    kind: "Workshop",
    format: "Virtual",
          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-12 items-end">
            <div className="col-span-12 lg:col-span-8">
              ...
              <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[96px]">
                ...
                Readings.
                <br />
                <span className="italic text-primary font-light">Quiet meet-ups.</span>
              </h1>
              <p className="mt-8 max-w-2xl text-[17px] lg:text-[18px] leading-[1.6] text-ink/75">
                Virtual sessions every month, in-person meet-ups every
                quarter. Members of the{" "}
                <Link href={routes.connect.slack} className="pencil-link text-ink">Slack community</Link>{" "}
                and{" "}
                <Link href={routes.connect.newsletter} className="pencil-link text-ink">newsletter</Link>{" "}
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className="p-6 rounded-3xl bg-background-elev border border-border">
                ...
                <p className="font-display text-[20px] leading-[1.2] tracking-[-0.005em]">
                  ...
                  <span className="italic text-primary">in the newsletter.</span>
                </p>
                <Link
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-12">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Three things
              <span className="italic text-primary"> to put on the calendar.</span>
            </h2>
          </div>
                ...
                >
                  ...
                  <div className="col-span-12 md:col-span-3 p-6 lg:p-8 md:border-r border-ink/10 flex md:flex-col md:justify-center gap-3 md:gap-0">
                    ...
                    <div className="md:mt-4">
                      <p className="font-display text-[24px] lg:text-[28px] leading-[1] tracking-[-0.01em]">
                        {e.dateLabel}
                      </p>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-12">
            ...
            <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
              Four shapes.
              <br />
              <span className="italic text-primary">One vibe.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            {[
              ...
              >
                ...
                <p className="mt-3 text-[13.5px] text-ink/75 leading-[1.55]">{f.p}</p>
              </article>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-12 gap-10 mb-12 items-end">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
                Recordings
                <span className="italic text-primary"> and notes.</span>
              </h2>
            </div>
              ...
              return (
                ...
                >
                  <div className="col-span-12 md:col-span-2">
                    ...
                    <p className="mt-1 text-[10px] font-mono text-ink/45">{e.timeLabel}</p>
                  </div>
            ...
            <div className="relative grid grid-cols-12 gap-8 items-center">
              <div className="col-span-12 lg:col-span-8">
                ...
                <p className="mt-5 text-[15px] text-background-elev/75 leading-[1.6] max-w-xl">
                  Got a city without a meet-up? Want to run a workshop
                  for your agency's clients? We cover the logistics —
                  you bring the room and the regulars.
                </p>
              </div>

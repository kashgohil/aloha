...
export default async function PersonaPage({
	...
	return (
		<>
						...
						<div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 mb-14 items-end">
							<div className="col-span-12 lg:col-span-7">
								...
								<h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
									Three things
									<br />
									<span className="text-primary">that stop being hard.</span>
								</h2>
							</div>
							<p className="col-span-12 lg:col-span-5 text-[15.5px] text-ink/70 leading-[1.55]">
								Not an exhaustive feature list. The three chronic annoyances we
								heard over and over from {p.name.toLowerCase()} — and what Aloha
								does about each.
							</p>
						</div>
								...
								>
									<div className="col-span-12 md:col-span-5 p-8 lg:p-10 bg-ink text-background-elev flex flex-col justify-between min-h-[200px]">
										<div className="flex items-center gap-3 mb-6">
											...
											<span className="font-display text-[18px] text-peach-300">
												0{i + 1}
											</span>
										</div>
			...
			<section
				id="day"
				className="py-24 lg:py-32 bg-background-elev wavy pb-32 lg:pb-40"
			>
				<div className="max-w-[1180px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-16 items-start">
					<div className="col-span-12 lg:col-span-5">
						...
						<h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
							Five beats.
							<br />
							<span className="text-primary">One calm day.</span>
						</h2>
						<p className="mt-6 text-[16px] text-ink/75 leading-[1.6] max-w-md">
							What a Tuesday actually looks like when Aloha is doing what it
							should. Deep-work blocks are silent; the tool only surfaces what
							wants your thumb.
						</p>
						...
						<ol className="relative border-l-2 border-border-strong/60 pl-8 space-y-6">
							{p.day.map((d, i) => (
								<li key={i} className="relative">
									<span
										className={`absolute -left-[43px] top-1 w-5 h-5 rounded-full ${d.tone} border border-ink/20`}
									/>
									<div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-5">
										...
										<span className="text-[15px] text-ink/85 leading-[1.55]">
											{d.label}
										</span>
									</div>
								</li>
					...
					<div className="max-w-[1180px] mx-auto px-6 lg:px-10">
						<div className="mb-14">
							...
							<h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
								Not features.
								<br />
								<span className="text-primary">Muscle memory.</span>
							</h2>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
							{p.topFeatures.map((f, i) => (
								...
								>
									<span className="font-display text-[28px] text-ink/35 leading-none">
										0{i + 1}
									</span>
							...
							return (
								<li key={slug}>
									<Link
										...
										className="h-full rounded-2xl border border-border bg-background-elev p-5 lg:p-6 flex items-start gap-4 group hover:bg-muted/40 hover:border-border-strong transition-colors"
									>
										{icon && (
										...
										<div className="min-w-0">
											...
											<p className="mt-2 text-[12px] text-ink/55 leading-snug">
												{ch.tagline}
											</p>
										</div>
									</Link>
						...
						<div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-16 items-center">
							<div className="col-span-12 lg:col-span-5">
								...
								<h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
									Start with the
									<br />
									<span className="text-primary">plan that fits.</span>
								</h2>
								<p className="mt-6 text-[16px] text-ink/75 leading-[1.6] max-w-md">
									Most {p.name.toLowerCase()} land here. If it's wrong for you,
									switching plans is two clicks — your content comes along.
								</p>
							...
							<div className="col-span-12 lg:col-span-7">
								<article
									className={`rounded-3xl ${p.accent} p-8 lg:p-10 relative`}
								>
									...
									<h3 className="font-display text-[36px] lg:text-[44px] leading-none tracking-[-0.02em]">
										{p.recommendedPlan.name}
									</h3>
			...
			{/* ─── TESTIMONIAL ─────────────────────────────────────────────── */}
			<section className="py-20 lg:py-24 bg-peach-300 wavy pb-32 lg:pb-40">
				<div className="max-w-[1100px] mx-auto px-6 lg:px-10">
					<figure className="relative rounded-3xl p-10 lg:p-14 overflow-hidden">
						<MessageSquareQuote className="relative w-8 h-8 text-ink/40 mb-6" />
						...
						<figcaption className="relative mt-8 flex items-center gap-4">
							...
							<div>
								...
								<p className="text-[13px] text-ink/60">{p.testimonial.r}</p>
							</div>
						</figcaption>
					</figure>
				</div>
					...
					<div className="max-w-[1180px] mx-auto px-6 lg:px-10">
						<div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 mb-10 items-end">
							<div className="col-span-12 lg:col-span-7">
								...
								<h2 className="font-display text-[32px] lg:text-[44px] leading-[1.02] tracking-[-0.02em]">
									Five other ways
									<span className="text-primary"> people use Aloha.</span>
								</h2>
							</div>
					...
					<div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 items-end">
						<div className="col-span-12 lg:col-span-8">
							<h2 className="font-display text-[44px] sm:text-[56px] lg:text-[80px] leading-[0.98] tracking-[-0.025em]">
								{p.cta.line1}
								<br />
								<span className="text-peach-300">{p.cta.line2}</span>
							</h2>
						</div>

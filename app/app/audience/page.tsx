      ...
      <header className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
        <div>
          ...
          <h1 className="mt-3 font-display text-[44px] lg:text-[52px] leading-[1.02] tracking-[-0.03em] text-ink font-normal">
            Audience,
            <span className="text-primary font-light italic"> the quiet kind.</span>
          </h1>
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[88px] p-3.5 rounded-xl bg-background-elev border border-border-strong text-[14px] text-ink leading-[1.5] focus:outline-none focus:border-ink transition-colors resize-y"
                  />
                </div>
              </div>
        ...
        <aside className="lg:col-span-5 space-y-6">
          ...
          {allTags.length > 0 ? (
            <div className="rounded-3xl border border-border bg-background-elev p-5">
              ...
              <p className="mt-3 text-[12px] text-ink/50 leading-[1.5]">
                Segment filtering and manual tagging land next — today tags
                are assigned automatically on signup.
              </p>
            </div>
          ) : null}
        </aside>
  ...
  return (
    <div className="flex items-end justify-between">
      ...
      {href && hrefLabel ? (
        <Link
          href={href}
          target={href.startsWith("http") || href.startsWith("/u/") ? "_blank" : undefined}
          rel="noreferrer"
